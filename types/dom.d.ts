...
export type DomEventType<K extends keyof HTMLElementEventMap> = Parameters<typeof HTMLElement.prototype.addEventListener<K>>[1];
export type DomEventListener<T extends HTMLElement, K extends keyof E, E extends HTMLElementEventMap = HTMLElementEventMap> = (this: T, ev: E[K]) => unknown;
export type DomEventListenerOption<T extends HTMLElement, K extends keyof E, E extends HTMLElementEventMap = HTMLElementEventMap> = {
