...
type EventHandler<E extends Event = Event, T extends EventTarget = Element> = (event: E & {
...
export interface HTMLButtonAttributes extends HTMLAttributes<HTMLButtonElement> {
    ...
    command?: "show-modal" | "close" | "request-close" | "show-popover" | "hide-popover" | "toggle-popover" | (string & {}) | undefined | null;
...
export interface HTMLLinkAttributes extends HTMLAttributes<HTMLLinkElement> {
    as?: "fetch" | "audio" | "audioworklet" | "document" | "embed" | "font" | "frame" | "iframe" | "image" | "json" | "manifest" | "object" | "paintworklet" | "report" | "script" | "serviceworker" | "sharedworker" | "style" | "track" | "video" | "webidentity" | "worker" | "xslt" | "" | undefined | null;
    crossorigin?: "anonymous" | "use-credentials" | "" | undefined | null;
    href?: string | undefined | null;
    hreflang?: string | undefined | null;
...
export interface HTMLMetaAttributes extends HTMLAttributes<HTMLMetaElement> {
    ...
    "http-equiv"?: "accept-ch" | "content-security-policy" | "content-type" | "default-style" | "refresh" | "x-ua-compatible" | undefined | null;
    name?: string | undefined | null;
    media?: string | undefined | null;
}
...
export interface SVGAttributes<T extends EventTarget> extends AriaAttributes, DOMAttributes<T> {
    ...
    "alignment-baseline"?: "auto" | "baseline" | "before-edge" | "text-before-edge" | "middle" | "central" | "after-edge" | "text-after-edge" | "ideographic" | "alphabetic" | "hanging" | "mathematical" | "inherit" | undefined | null;
